        ...
        return new Promise ((resolve, reject) => {
            for (let y = 0; y < 8; ++y) {
                for (let x = 0; x < 8; ++x) {
                    ...
                    this.ctx.fillText((8 - y).toString(), 3 + this.boardOffsetX, y * this.squareSize + 8 + this.boardOffsetY);

                    let letter = String.fromCharCode(97 + x);
                    this.ctx.fillStyle = (x % 2 == 0) ? this.colors.light : this.colors.dark;
...
module.exports = whiteChessboard;


// Test the chessboard module

// let p1 = {
//     id: '590350797230047263',
//     username: 'Galactic',
//     elo: 1300
// }
...
// let board = new whiteChessboard(50, p1, p2);
